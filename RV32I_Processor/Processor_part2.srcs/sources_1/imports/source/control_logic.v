module Control_Logic(instruction, jump, ALUControl, dmemMode, 
    ...
    always @(*) begin
        case (opcode)
            ...
            7'b1101111:         // JAL
                ...
                instructionruction following the jump (pc+4) into register rd.*/
                begin
                    dmemMode    = 3'b000;
                    dmemWE      = 1'b0;
                    regWE       = 1'b1;
            ...
            7'b0110011:
                ...
                endcase
            /*
                instructionructions are not necessary for Single Cycle Implementations

            7'b0001111:
                if (instruction[31:28] == 0 and instruction[19:7] == 0) begin
                    // FENCELL
                end 
                else if (instruction[31:7] == 25'h0000020) begin
                    // FENCE.I
                end
            7'b1110011:
				case (funct3)
					3'b000:
						if (instruction[11:7] == 0 and instruction[19:15] == 0 and instruction[31:20] == 0) begin
											// ECALL
						end
						else if (instruction[11:7] == 0 and instruction[19:15] == 0 and instruction[31:20] == 1) begin
						                    // EBREAK
						end
					3'b001:					// CSRRW
					3'b010:					// CSRRS
